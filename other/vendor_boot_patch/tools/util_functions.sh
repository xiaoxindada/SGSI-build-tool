...
get_slot() {
  ...
  test "$slot" && ui_print "Currnt device slot exists， current slot is: $slot";
}
...
mount_apex() {
  ...
  export BOOTCLASSPATH=${APEXJARS}\
    $FWK/framework.jar:$FWK/ext.jar:$FWK/telephony-common.jar:$FWK/voip-common.jar:$FWK/ims-common.jar:$FWK/telephony-ext.jar
}
